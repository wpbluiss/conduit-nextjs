...
const VALID_TABS: SettingsTabKey[] = ["profile", "workspace", "business", "specialists", "voice", "team", "usage", "billing", "security", "notifications", "integrations", "appearance", "api", "referrals"];
