...
// Below-fold sections code-split so the browser can parse Hero + Navbar first,
// then stream in the remaining component chunks as they scroll into view.
// SSR is kept (default) so markup is in the initial HTML for SEO.
