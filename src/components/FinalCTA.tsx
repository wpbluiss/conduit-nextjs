  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <PraxisButton asLink href="/auth/sign-up" variant="primary" size="lg" className="justify-center">
            Open Praxis Console
            <ArrowRight size={16} weight="bold" />
          </PraxisButton>
          <PraxisButton asLink href="/products" variant="secondary" size="lg" className="justify-center">
