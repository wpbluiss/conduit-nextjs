...
const DEPARTMENTS = [
  {
    ...
    agents: 47,
    color: "#00e5a0",
    tasks: ["Code review", "CI/CD pipelines", "Bug triage", "Architecture"],
    status: "OPTIMAL",
    load: 87,
  },
  {
    ...
    agents: 31,
    color: "#3b82f6",
    tasks: ["Lead scoring", "Outbound sequences", "Pipeline management", "Forecasting"],
    status: "OPTIMAL",
    load: 92,
  },
  {
    ...
    agents: 24,
    color: "#ff6b35",
    tasks: ["Content generation", "Campaign analysis", "SEO optimization", "Social"],
    status: "SCALING",
    load: 78,
  },
  {
    ...
    agents: 38,
    color: "#00c9ff",
    tasks: ["Ticket resolution", "Escalation routing", "Knowledge base", "CSAT"],
    status: "OPTIMAL",
    load: 95,
  },
  {
    ...
    agents: 19,
    color: "#a855f7",
    tasks: ["Invoice processing", "Expense auditing", "Revenue forecasting", "Compliance"],
    status: "OPTIMAL",
    load: 63,
  },
  {
    ...
    agents: 15,
    color: "#f59e0b",
    tasks: ["Candidate screening", "Onboarding", "Benefits admin", "Policy Q&A"],
    status: "NOMINAL",
    load: 54,
  },
  {
    ...
    agents: 12,
    color: "#ef4444",
    tasks: ["Contract review", "Risk assessment", "Compliance monitoring", "IP watch"],
    status: "NOMINAL",
    load: 41,
  },
  {
    ...
    agents: 28,
    color: "#10b981",
    tasks: ["Vendor management", "Inventory tracking", "Process optimization", "Logistics"],
    status: "OPTIMAL",
    load: 83,
  },
  {
    ...
    agents: 22,
    color: "#6366f1",
    tasks: ["User research synthesis", "Spec writing", "Roadmap planning", "Metrics"],
    status: "SCALING",
    load: 71,
  },
];
  ...
  return (
    ...
    >
      ...
      <div className="flex items-start justify-between mb-4">
        <div>
          <h3 className="font-[family-name:var(--font-display)] font-semibold text-sm mb-1">
            {dept.name}
          </h3>
        ...
        <div className="text-right">
          ...
          <div className="font-[family-name:var(--font-mono)] text-[10px] text-text3">
            AGENTS
          </div>
        </div>
      </div>
      ...
      <div className="mb-4">
        <div className="flex justify-between mb-1">
          <span className="font-[family-name:var(--font-mono)] text-[10px] text-text3">
            CAPACITY
          </span>
          <span className="font-[family-name:var(--font-mono)] text-[10px] text-text3">
            {dept.load}%
      ...
      <div className="flex flex-wrap gap-1.5">
        {dept.tasks.map((task) => (
          <span
            key={task}
            className="px-2 py-0.5 rounded text-[10px] font-[family-name:var(--font-mono)] text-text3 border border-border bg-bg2/50"
          >
            {task}
          </span>
        ))}
...
export default function DepartmentGrid() {
  return (
    <section id="departments" className="relative py-32 px-6">
      {/* Background accent */}
      <div className="absolute inset-0 pointer-events-none">
        <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[600px] bg-accent/[0.02] rounded-full blur-[150px]" />
      </div>
      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        >
          ...
          <div className="flex flex-wrap justify-center gap-6 mt-8 mb-4">
            {[
              { label: "TOTAL AGENTS", value: "236", color: "text-accent" },
              { label: "UPTIME", value: "99.97%", color: "text-accent" },
              { label: "AVG RESPONSE", value: "1.2s", color: "text-blue" },
              { label: "TASKS / HR", value: "14,208", color: "text-orange" },
            ].map((stat) => (
              <div key={stat.label} className="text-center">
                <div
                  className={`font-[family-name:var(--font-display)] text-xl font-bold tabular-nums ${stat.color}`}
                >
                  {stat.value}
                </div>
                <div className="font-[family-name:var(--font-mono)] text-[10px] text-text3 tracking-wider">
                  {stat.label}
                </div>
              </div>
            ))}
