          ...
          {account.has_stripe_customer && tier.monthlyPriceCents > 0 && (
            isCanceling ? (
              ...
              <button
                ...
                disabled={busy !== null}
                className="text-[11px] underline underline-offset-2 text-[var(--color-text-muted)] hover:text-[var(--color-destructive,var(--cx-danger))] transition-colors disabled:opacity-40 text-center"
              >
                Cancel subscription
              </button>
            )
