        ...
        >
          ...
          >
            ...
            <div
              ...
              style={{
                background:
                  "radial-gradient(ellipse 50% 50% at 90% 10%, rgba(91, 99, 232, 0.12) 0%, transparent 60%), radial-gradient(ellipse 40% 40% at 10% 90%, rgba(91, 99, 232, 0.08) 0%, transparent 60%)",
              }}
            />
          </div>
        </motion.div>
